...
global.tik = '-' 
global.tautanwa = '-'
global.wame = '-' // kalau gk punya bisa ganti pake gini wa.me/62895412691100

/*============== PAYMENT ==============*/
global.pdana = '0877 3220 0388' //dana
global.povo = '0877 3220 0388' //ovo
global.pgopay = '0877 3220 0388' //gopay
global.plinkaja = '0877 3220 0388' //link aja
global.ppulsa = '0877 3220 0388' //telkomsel
global.ppulsa2 = '0895 4126 91100' // kalau ada kartu lain isi aja
global.psaweria = '-'

/*============== NOMOR ==============*/
global.nomorbot = '62895412691100'
global.nomorown = '62895412691100'
global.nomorown1 = '62895412691100' //pake No Pacar lo Juga Boleh
global.namebot = 'BTR X-BOT OFC MD'
global.nameown = 'BTR OFC'
global.nameown1 = 'SALSA NOVIANTI' //Pake Nama Pacar Lo Juga Boleh

//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ INFO BIO DATA OWN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com/sadboy.edtz' // ig lo
global.sigpcr = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com/salsanvnti' // ig cewek lo
/*============== Github Thanks To ==============*/
...
/*============== WATERMARK ==============*/
global.gcname = 'BTR X-BOT OFC MD'//nama group kalian
global.readMore = readMore
global.wm = '                「 BTR X-BOT OFC MD 」'
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘BTR X-BOT OFC MD ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ BTR X-BOT OFC MD '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By BTR OFC`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '              「 BTR X-BOT OFC MD  あ」'
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
global.danied = pickRandom(["✘ 𝗘𝗿𝗼𝗿 𝟰𝟬𝟰","𝘼𝙠𝙨𝙚𝙨 𝘿𝙞𝙩𝙤𝙡𝙖𝙠","⚠️ 𝘼𝙘𝙘𝙨𝙚𝙨 𝘿𝙖𝙣𝙞𝙚𝙙 ⚠️"])

/*============== STICKER WM ==============*/
global.stickpack = 'BTR X-BOT OFC MD'
global.stickauth = `By ©BTR OFC`
...
global.urlnya = "https://www.instagram.com/sadboy.edtz"
